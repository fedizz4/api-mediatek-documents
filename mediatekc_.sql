...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : lun. 03 avr. 2023 à 11:07
...
INSERT INTO `service` (`id`, `idService`) VALUES
(1, 'administratif'),
(2, 'prêts'),
(3, 'culture'),
(4, 'administrateur');
...
('00001', 'bugatti', 'bugatti2023', '0'),
('00002', 'saxo', 'saxo2001', '1'),
('00003', 'roby', 'roby0', '2'),
('00004', 'jijititi', 'jijititi4', '3');
